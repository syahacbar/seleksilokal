...
class Seleksiotomatis extends MY_Controller {
    ...
    public function index()
    {
        ...
        foreach($data as $datares){
            ...
            echo '<strong>Pilihan 1 : '.ucwords(strtolower($datares->namaprodi)).' (Daya tampung : '.$dayatampung1.', Peminat : '.$peminat1.', Terima : '.$terima1.', Sisa : '.$sisa1.')</strong><br>';
        ...
        foreach($data as $datares){
            ...
            echo '<strong>Pilihan 2 : '.ucwords(strtolower($datares->namaprodi)).' (Sisa kuota dari pilihan 1 : '.$dayatampung2.', Peminat : '.$peminat2.', Terima : '.$terima2.', Sisa : '.$sisa2.')</strong><br>';
        ...
        foreach($data as $datares){
            ...
            $limit2 = $datares->dayatampung;
            $data2 = $this->get_pilihan2_sort_by_nilai($datares->namaprodi,$limit2);
            $dayatampung2 = $datares->dayatampung;
            $peminat2 = count($data2);
            $terima2 = $peminat2 <= $dayatampung2 ? $peminat2 : $dayatampung2;
            $sisa2 = $dayatampung2-$terima1-$terima2;
            ...
            echo '<strong>Pilihan 3 : '.ucwords(strtolower($datares->namaprodi)).' (Sisa kuota dari pilihan 1 dan pilihan 2 : '.$dayatampung3.', Peminat : '.$peminat3.', Terima : '.$terima3.', Sisa : '.$sisa3.')</strong><br>';
