...
<link href="<?php echo base_url('public/bootstrap/css/bootstrap.min.css')?>" rel="stylesheet">
  ...
  <div class="box">
   <div class="box-header">
     <h3 class="box-title">Master Data Jurusan SLTA</h3>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('jurusanslta/ajax_list')?>",
            "type": "POST"
        },
...
function edit_record(id)
{
    ...
    $.ajax({
        url : "<?php echo base_url('jurusanslta/ajax_edit/')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
 
            $('[name="idjurusanslta"]').val(data.idjurusanslta);
            $('[name="kodejurusanslta"]').val(data.kodejurusanslta);
...
function save()
{
    ...
    if(save_method == 'add') { 
        url = "<?php echo site_url('jurusanslta/ajax_add')?>";
    } else {
        url = "<?php echo site_url('jurusanslta/ajax_update')?>";
    }
    ...
    $.ajax({
        ...
        success: function(data)
        {
            if (data.hasil !== "sukses") {
                $("#error_kodejurusanslta").html(data.error.kodejurusanslta);
...
function delete_record(id)
{
    if(confirm('Apakah anda yakin akan menghapus data?'))
    {
        ...
        $.ajax({
            url : "<?php echo base_url('jurusanslta/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title">Form Jurusan SLTA</h3>
            </div>
            <div class="modal-body form">
                <form action="#" id="form" class="form-horizontal">
                    <input type="hidden" value="" name="idjurusanslta"/> 
                    <div class="form-body">
                        <div class="form-group">
                            <label class="control-label col-md-4">Kode Jurusan SLTA</label>
                            <div class="col-md-8">
                                <input name="kodejurusanslta" placeholder="Kode Jurusan SLTA" class="form-control" type="text">
                                <span class="text-danger" id="error_kodejurusanslta"></span>
                            </div>
                        </div>
                        <div class="form-group">
