    ...
    <div class="col-md-12">
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Form Ubah Peserta</h3>
        </div>
        <!-- /.box-header -->
        <!-- form start -->
          ...
          <?php if(isset($msg) || validation_errors() !== ''): ?>
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="text" name="namapeserta" class="form-control" id="namapeserta" value="<?=$namapeserta;?>" placeholder="Nama Lengkap">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="text" name="tempatlahir" class="form-control" id="tempatlahir" value="<?=$tempatlahir;?>"placeholder="Tempat Lahir">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <div class="input-group date">
                    ...
                    <input type="text" name="tanggallahir" class="form-control" id="tanggallahir" value="<?=$tanggallahir;?>"placeholder="Tanggal-Bulan-Tahun, Contoh: 31-12-2000">
                  </div>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="number" name="tahunlulus" class="form-control" id="tahunlulus" value="<?=$tahunlulus;?>" placeholder="Tahun Terakhir Lulus">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="text" name="asalslta" class="form-control" id="asalslta" value="<?=$asalslta;?>" placeholder="Nama Asal Sekolah">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                <input type="number"  name="nbahasa" class="form-control" id="nbahasa" min="0" step=".01" value="<?=$nbahasa;?>" placeholder="Penuisan Desimal Menggunakan Titik, Contoh : 75.33">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="number" name="nipa" class="form-control" id="nipa" min="0" step=".01" value="<?=$nipa;?>" placeholder="Penuisan Desimal Menggunakan Titik, Contoh : 75.33">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="number" name="nips" class="form-control" id="nips" min="0" step=".01" value="<?=$nips;?>" placeholder="Penuisan Desimal Menggunakan Titik, Contoh : 75.33">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="number" name="nverbal" class="form-control" id="nverbal" min="0" step=".01" value="<?=$nverbal;?>" placeholder="Penuisan Desimal Menggunakan Titik, Contoh : 75.33">
                </div>
              </div>
              ...
              <div class="form-group">
                <div class="col-md-11">
                <a href="<?php echo site_url('peserta');?>" class="btn btn-default pull-right"> Kembali </a>
